		...
		if($this->client_type)
		{
			...
			switch($this->client_type)
			{
				case 'Memcached':
					...
					/*for auto discover memcached */
					//$this->m->setOption(Memcached::OPT_CLIENT_MODE, Memcached::DYNAMIC_CLIENT_MODE);
					/* end auto discover memcached */
					$this->m->setOption(Memcached::OPT_LIBKETAMA_COMPATIBLE, true);
					$this->m->setOption(Memcached::OPT_NO_BLOCK, true);
					$this->m->setOption(Memcached::OPT_POLL_TIMEOUT, 50 );
					$this->m->setOption(Memcached::OPT_CONNECT_TIMEOUT, 50 );
					$this->m->setOption(Memcached::OPT_SEND_TIMEOUT, 50000 );
					$this->m->setOption(Memcached::OPT_RECV_TIMEOUT, 50000 );
					// $this->m->setOption(Memcached::OPT_CACHE_LOOKUPS, true);
